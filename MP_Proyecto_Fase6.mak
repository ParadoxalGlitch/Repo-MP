...
#......................................
all: presentacion $(BIN)/MP_Proyecto_Fase6
	@echo Terminado
...
$(BIN)/MP_Proyecto_Fase6 : $(OBJ)/main_MP_Proyecto_Fase6.o \
	...
	g++ -o $(BIN)/MP_Proyecto_Fase6 $(OBJ)/main_MP_Proyecto_Fase6.o \
           -L$(LIB) -lVectorDepartamento -lVectorProfesor -lVectorAdscripcion \
           -lVectorEncargo -lDepartamento -lProfesor -lEncargo -lAdscripcion \
           -lutils -lFecha 
...
$(OBJ)/main_MP_Proyecto_Fase6.o : $(SRC)/main_MP_Proyecto_Fase6.cpp \
	...
	g++ -c -o $(OBJ)/main_MP_Proyecto_Fase6.o \
	          $(SRC)/main_MP_Proyecto_Fase6.cpp -I$(INCLUDE) -std=c++14
